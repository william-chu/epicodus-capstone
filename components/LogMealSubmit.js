    ...
    >
      <View style={styles.container}>
        <View style={styles.flex}>
          ...
          <Text style={styles.h1}>Meal Logged</Text>
        </View>
        <Text style={styles.h3}>
          Accurately log your diet every day to increase the accuracy of our
          analysis.
        </Text>
        <Text style={styles.h3}>Keep it up!</Text>
        <Text style={styles.p}>
          Use <Text style={styles.strong}>Track BM</Text> to find meals with
          possible triggers
        </Text>
        <TouchableOpacity
          onPress={() => {

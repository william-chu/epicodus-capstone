...
export function getSuspectMeals(
  masterMealLog,
  suspectMeals,
  mealLogDateKey,
  time
  ...
  let newSuspectMeals;
  if (
    lookupMealDate1 === lookupMealDate2 &&
    suspectMeals[lookupMealDate1] === undefined
  ) {
    newSuspectMeals = Object.assign({}, suspectMeals, {
      [lookupMealDate1]: {
        [lookupMeal1]: masterMealLog[lookupMealDate1][lookupMeal1]
      }
    });
    newSuspectMeals[lookupMealDate2][lookupMeal2] =
      masterMealLog[lookupMealDate2][lookupMeal2];
  } else if (
    suspectMeals[lookupMealDate1] === undefined &&
    suspectMeals[lookupMealDate2] === undefined
  ) {
    newSuspectMeals = Object.assign({}, suspectMeals, {
      [lookupMealDate1]: {
        [lookupMeal1]: masterMealLog[lookupMealDate1][lookupMeal1]
      ...
      [lookupMealDate2]: {
        [lookupMeal2]: masterMealLog[lookupMealDate2][lookupMeal2]
      }
    });
  } else if (
    lookupMealDate1 !== lookupMealDate2 &&
    ...
    newSuspectMeals[lookupMealDate1][lookupMeal1] =
      masterMealLog[lookupMealDate1][lookupMeal1];
  } else {
    newSuspectMeals = Object.assign({}, suspectMeals);
    newSuspectMeals[lookupMealDate1][lookupMeal1] =
      masterMealLog[lookupMealDate1][lookupMeal1];

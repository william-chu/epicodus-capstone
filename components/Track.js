...
export default class Track extends React.Component {
  ...
  handleTrackSubmitPress = () => {
    ...
    onTrackSubmit(
      ...
      this.state.selectedScaleInput,
      this.state.selectedTimeInput
    );
  };
        ...
        <View style={styles.container}>
          ...
          <View style={styles.flex}>
            ...
            <RadioGroup
              ...
              onPress={() => {
                this.onSetScale,
                  (selectedScale = this.state.scale.find(
                    e => e.selected == true
                  )),
                  (selectedScale = selectedScale
                    ? selectedScale.value
                    : this.state.scale[0].label),
                  this.onSetSelectedScaleInput(selectedScale);
              }}
              flexDirection="row"
            />
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate("BristolScale")}
            >
          ...
          <View style={styles.flex}>
            ...
            <RadioGroup
              ...
              onPress={() => {
                this.onSetTime,
                  (selectedTime = this.state.time.find(
                    e => e.selected == true
                  )),
                  (selectedTime = selectedTime
                    ? selectedTime.value
                    : this.state.time[0].label),
